...
- Geo meta tags for Mérida, Badajoz, Spain
- ICBM coordinates
- Regional targeting

### 6. **Open Graph Enhanced** ✅
...
4. **Local SEO**: Geographic targeting for Mérida/Badajoz
...
- ✅ `src/layouts/Layout.astro` - Enhanced with all SEO features
- ✅ `src/pages/index.astro` - Updated with product/FAQ schemas
- ✅ `src/pages/sitemap.xml.ts` - NEW: Dynamic sitemap generator
- ✅ `src/lib/seo-schemas.ts` - NEW: Structured data library
