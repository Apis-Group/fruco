...
En CARNES Y VEGETALES SL nos preocupamos por la privacidad y la transparencia. A continuación, le indicamos en detalle los tratamientos de datos personales que realizamos, así como toda la información relativa a los mismos.
...
- La tramitación de consultas, asesoramiento, encargos, solicitudes o cualquier tipo de petición que sea realizada por el usuario a través de cualquiera de las formas de contacto que se ponen a disposición del usuario en el sitio web de CARNES Y VEGETALES SL.
...
- **CIF:** B06603161
- **Dirección:** POL. IND. EL PRADO, C/ SEVILLA, PARC. 1-2 – 06800 – MÉRIDA – BADAJOZ
- **Teléfono:** 924 378 631
- **Email:** info@fruco.es

### ¿Con qué finalidad tratamos sus datos personales?

En CARNES Y VEGETALES SL tratamos la información que nos facilitan las personas interesadas con el fin de realizar las siguientes finalidades:
...
- **GESTIÓN DE TRABAJADORES:** Gestionar la relación laboral y control empresarial.
...
- **GESTIÓN DE VIDEOVIGILANCIA:** Garantizar la seguridad de personas, bienes e instalaciones y el control empresarial.
- **GESTIÓN DE SELECCIÓN DE PERSONAL:** Gestionar los Curriculums Vitae recibidos y realizar los procesos de selección de personal.
- **GESTIÓN DE ALUMNOS:** Prestación de servicios de educación; Formación práctica.
- **GESTIÓN DEL CONSEJO DE ADMINISTRACIÓN:** Registro de los miembros del consejo de administración que tienen representación legal en la asociación para toma de decisiones.
...
- En referencia a los datos obtenidos a través de los formularios de contacto mientras no solicite la supresión de sus datos.
...
- Interés legítimo del responsable: La utilización de la red social WhatsApp de mensajería instantánea como medio de comunicación. Enviar comunicaciones comerciales vía electrónica sobre nuestros productos y servicios.
...
- Interés legítimo del responsable: La utilización de la red social WhatsApp de mensajería instantánea como medio de comunicación.
...
- Interés legítimo del responsable: Control empresarial.
...
- Control empresarial: a través del circuito de videovigilancia.

**GESTIÓN DE SELECCIÓN DE PERSONAL:**

- Consentimiento del interesado: Gestionar los Curriculums Vitae recibidos y realizar los procesos de selección de personal.

**GESTIÓN DE ALUMNOS:**

- Ejecución de un contrato: Realizar la gestión administrativa, contable y fiscal de los servicios solicitados.
- Consentimiento del interesado: Realizar la gestión administrativa y custodia de los datos de los alumnos.

**GESTIÓN DEL CONSEJO DE ADMINISTRACIÓN:**

- Ejecución de un contrato: Realizar la gestión del consejo para toma de decisiones y cumplimiento estatutario.
...
- Administración Tributaria, con la finalidad de cumplir con las obligaciones legales (requisito legal).
- Entidades bancarias, con la finalidad de realizar los pagos correspondientes (requisito contractual).
- Fundación estatal para la formación en el empleo (Fundae), con la finalidad de realizar la gestión de los cursos bonificados (requisito contractual).
...
- Administración tributaria, con la finalidad de cumplir con las obligaciones legales (requisito legal).
- Administraciones públicas con competencia en la materia, con la finalidad de cumplir con las obligaciones legales (requisito legal).
...
Están previstas las siguientes transferencias de datos a terceros países de su número de teléfono por la utilización de la red social WhatsApp de mensajería instantánea como medio de comunicación:
...
Cualquier persona tiene derecho a obtener confirmación sobre si en CARNES Y VEGETALES SL estamos tratando, o no, datos personales que les conciernan.
...
En determinadas circunstancias y por motivos relacionados con su situación particular, los interesados podrán oponerse al tratamiento de sus datos. En este caso, CARNES Y VEGETALES SL dejará de tratar los datos, salvo por motivos legítimos imperiosos, o el ejercicio o la defensa de posibles reclamaciones.

Podrá ejercitar materialmente sus derechos de la siguiente forma: dirigiéndose a **info@fruco.es** o **PG. IND. EL PRADO, C/ SEVILLA, PARC. 1-2 – 06800 MÉRIDA, BADAJOZ (ESPAÑA)**.
...
Los datos personales que tratamos en CARNES Y VEGETALES SL proceden del propio interesado o su representante legal.
