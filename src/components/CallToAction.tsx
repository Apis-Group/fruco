        ...
        >
          {contactInfo.email && (
            <div className="group cursor-pointer">
              ...
              <p className="text-gray-300 group-hover:text-white transition-colors duration-300">{contactInfo.email}</p>
            </div>
          )}
          ...
          {contactInfo.phone && (
            <div className="group cursor-pointer">
              ...
              <p className="text-gray-300 group-hover:text-white transition-colors duration-300">{contactInfo.phone}</p>
            </div>
          )}
          ...
          {contactInfo.address && (
            <div className="group cursor-pointer">
              ...
              <p className="text-gray-300 group-hover:text-white transition-colors duration-300">{contactInfo.address}</p>
            </div>
          )}
        </div>
      </div>
