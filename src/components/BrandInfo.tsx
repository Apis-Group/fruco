  ...
  return (
    ...
    >
          ...
          <div className="space-y-8">
            ...
            <div className="grid grid-cols-2 gap-8 pt-8">
              <div className="text-center">
                ...
                <p className="text-gray-400 text-sm uppercase tracking-wider">Años de Tradición</p>
              </div>
              <div className="text-center">
          ...
          <div className="space-y-8">
            ...
            >
              ...
              <div className="relative w-64 h-64 mx-auto">
                <div className="absolute inset-0 border-2 border-fruco-green/20 rounded-full animate-spin" style={{ animationDuration: '20s' }} />
                <div className="absolute inset-4 border-2 border-fruco-red/20 rounded-full animate-spin" style={{ animationDuration: '15s', animationDirection: 'reverse' }} />
                <div className="absolute inset-8 border-2 border-white/10 rounded-full animate-spin" style={{ animationDuration: '25s' }} />
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        ...
        <div className="absolute bottom-1/3 right-10 w-3 h-3 bg-fruco-red/40 rounded-full animate-pulse" style={{ animationDelay: '1s' }} />
        <div className="absolute top-2/3 left-1/3 w-1 h-1 bg-white/30 rounded-full animate-pulse" style={{ animationDelay: '2s' }} />
      </div>
    </section>
  );
};
